...
public class Main {
	public static void main(String[] args) {
		...
		//Aşağıdaki iki kod ile bütün komutları hash tablosuna ekleyerek makine karşılıklarına ulaşılabilir.
		//hashTableData<String, String> hashTablosu = hashTablosunaEkle(); 
		//hashTablosundanAl(hashTablosu);
		
		HashTableData<String, String> hashTableData1 = new HashTableData<>(211);
		hashTableData1.put("ADD #", "1000");
		hashTableData1.put("ADD $", "2000");
		hashTableData1.get("ADD #");
		hashTableData1.get("ADD $");
